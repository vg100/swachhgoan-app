...
const submitHandler=()=>{
dispatch(AuthRepositry.createUser({
    ...formValues,
        ...
        return (
            ...
            <Text style={{marginLeft:5,fontSize:20}}>{item}</Text>
                ...
                <TouchableOpacity
                            ...
                            style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#0B7CCE', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 5, marginVertical: 8 }}>
