  ...
  return (
    <ScrollView contentContainerStyle={{flexGrow: 1, padding: 20}}>
      <View
        ...
        <Image
          source={{
            uri: `${getEnvVariable()?.base_api_url}/${data.files[0]?.replace(
              /\\/,
              '/',
            )}`,
          }}
      ...
      <View
        ...
        <Text style={{fontSize: 15, marginTop: 5}}>
          No of Participant: {data.no_of_participant}
        </Text>
        <Text style={{fontSize: 15, marginTop: 5}}>
          No of Male: {data.no_of_males}
        </Text>
        <Text style={{fontSize: 15, marginTop: 5}}>
          No of Female: {data.no_of_females}
        </Text>
        <Text style={{fontSize: 15, marginTop: 5}}>
          No of Participant: {data.no_of_participant}
        </Text>
